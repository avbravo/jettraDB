...
public class RuleResource {
    ...
    public Response getRuleView() {
        Div container = new Div("rule-view");
        
        container.addComponent(new Label("title", "<h2 class='text-2xl font-bold text-white mb-4'>Rule Engine</h2>"));
        
        Div content = new Div("rule-content");
        ...
        content.addComponent(new Label("sub", "<p class='text-slate-500'>The Rule Engine interface is currently under development. <br>Please use the Jettra Shell or check back later.</p>"));
