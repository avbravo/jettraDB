...
public class Login extends Container {
    ...
    private void buildLayout() {
        ...
        card.setStyleClass("w-full j3d-card md:mt-0 sm:max-w-md xl:p-0");
        ...
        titleLabel.setStyleClass("text-xl font-bold leading-tight tracking-tight text-white md:text-2xl");
