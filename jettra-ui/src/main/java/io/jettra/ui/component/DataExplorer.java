...
public class DataExplorer extends Component {
        ...
        public static class DatabaseNode {
                ...
                public String render() {
                        ...
                        if ("No Databases".equals(name)) {
                                sb.append(
                                                "<div class='tree-db-name flex items-center gap-2 p-1.5 rounded-lg text-slate-500 cursor-default'>")
                                                .append("<svg class='w-3 h-3 text-slate-600' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z'></path></svg>")
                                                .append("<span class='italic'>").append(name).append("</span>")
                                                .append("</div>");
                        } else {
                                sb.append(
                                ...
                                sb.append("<span class='font-bold group-hover:text-white'>").append(name)
                                                .append("</span>");
                                ...
                                sb.append("<button class='p-1 hover:text-indigo-400 text-slate-500 transition-colors' title='Information' ")
                                                .append("hx-get='/dashboard/database/info?name=").append(name)
                                                .append("' ")
                                ...
                                sb.append(
                                                ...
                                                .append("hx-get='/dashboard/database/security?name=").append(name)
                                                .append("' ")
                                                .append("hx-target='#main-content-view' onclick='event.stopPropagation()'>")
                                ...
                                sb.append("<button class='p-1 hover:text-amber-400 text-slate-500 transition-colors' title='Edit Config' ")
                                                .append("hx-get='/dashboard/database/edit?name=").append(name)
                                                .append("' ")
                                                .append("hx-target='#main-content-view' onclick='event.stopPropagation()'>")
                                ...
                                sb.append(
                                                ...
                                                .append("hx-get='/dashboard/database/delete?name=").append(name)
                                                .append("' ")
                                                .append("hx-target='#main-content-view' onclick='event.stopPropagation()'>")
                                ...
                                if (!usersWithRoles.isEmpty() || true) { // Always show per user request example
                                        ...
                                        sb.append(
                                                        ...
                                                        .append(usersId).append("', '").append(usersIconId)
                                                        .append("')\">");
                                        sb.append(
        ...
        public static class CollectionNode {
                ...
                public String render(String dbName, String dbId, String engineName, String engineId) {
                        ...
                        sb.append(renderOption("Index", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z", "slate-500",
                                        "/dashboard/index?db=" + dbName + "&col=" + name, "#main-content-view"));
                        ...
                        sb.append(renderOption("Rules",
                                        ...
                                        "slate-500", "/dashboard/rule?db=" + dbName + "&col=" + name,
                                        "#main-content-view"));
                        sb.append("</div>");
                        sb.append("</div>");
                        return sb.toString();
